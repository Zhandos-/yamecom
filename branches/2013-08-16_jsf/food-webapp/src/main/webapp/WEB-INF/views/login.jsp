...
<div class="container">		
	<div class="row-fluid">
        <form class="log-page" method="post" id="form" action="<c:url value="/j_spring_security_check" />">
            <h3>Login to your account</h3>    
            <div class="input-prepend">
                <span class="add-on"><i class="icon-user"></i></span>
                <input class="input-xlarge" name="j_username" type="text" id="j_username" placeholder="Username">
            </div>
            <div class="input-prepend">
                <span class="add-on"><i class="icon-lock"></i></span>
                <input class="input-xlarge"  name="j_password" type="password" id="j_password" placeholder="Password">
            </div>
            <div class="controls form-inline">
                <label class="checkbox"><input id="_spring_security_remember_me" type="checkbox" name="_spring_security_remember_me" /> Stay Signed in</label>
